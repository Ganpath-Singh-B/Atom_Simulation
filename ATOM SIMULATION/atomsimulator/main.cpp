...
void display()
{
    ...
    if (value == -1)
    {
        /*char cn[] = "VIDYA VIKAS INSTITUTE OF ENGINEERING AND TECHNOLOGY MYSORE";
        ...
        char g1[] = "Prof.Ambika K B";
        drawhead(290, -250, 0, g1);
        char d1[] = "Assistant Professor";
